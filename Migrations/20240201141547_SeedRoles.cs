    ...
    public partial class SeedRoles : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[] { Guid.NewGuid().ToString(), Roles.SuperAdmin.ToString(), "SuperAdmin".ToUpper(), Guid.NewGuid().ToString() }
                );
            ...
            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "Name", "NormalizedName", "ConcurrencyStamp" },
                values: new object[] { Guid.NewGuid().ToString(), Roles.Moderator.ToString(), "Moderator".ToUpper(), Guid.NewGuid().ToString() }
                );
